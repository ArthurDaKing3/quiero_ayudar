...
import 'post_filtrar_categoria_model.dart';
export 'post_filtrar_categoria_model.dart';

class PostFiltrarCategoriaWidget extends StatefulWidget {
  const PostFiltrarCategoriaWidget({
    Key? key,
  ...
  @override
  _PostFiltrarCategoriaWidgetState createState() =>
      _PostFiltrarCategoriaWidgetState();
}

class _PostFiltrarCategoriaWidgetState
    extends State<PostFiltrarCategoriaWidget> {
  late PostFiltrarCategoriaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PostFiltrarCategoriaModel());
  }
          ...
          children: [
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    '${widget.busquedasRef?.where((e) => e.categoria == widget.categoriaRef).toList()?.length?.toString()}',
                  ...
                  if (widget.busquedasRef
                          ?.where((e) => e.categoria == widget.categoriaRef)
                          .toList()
                          ?.length ==
                      1)
                    Text(
