  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final cambiarContraUsersRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: Text(
                          'Le enviaremos un correo con un enlace para restablecer su contraseña, por favor ingrese el correo electrónico asociado con su cuenta.',
