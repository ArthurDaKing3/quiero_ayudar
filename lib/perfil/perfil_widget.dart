...
import '/donacion_detalles/donacion_detalles_widget.dart';
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          StreamBuilder<List<DonacionesRecord>>(
                            stream: queryDonacionesRecord(),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                              if (!snapshot.hasData) {
                                return Center(
                              ...
                              List<DonacionesRecord>
                                  columnDonacionesRecordList = snapshot.data!;
                              return Column(
                                mainAxisSize: MainAxisSize.max,
                                children: List.generate(
                                    columnDonacionesRecordList.length,
                                    (columnIndex) {
                                  final columnDonacionesRecord =
                                      columnDonacionesRecordList[columnIndex];
                                  return Visibility(
                                    visible: columnDonacionesRecord.reference !=
                                        null,
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        await Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                            builder: (context) =>
                                                DonacionDetallesWidget(
                                              donacionRef:
                                                  columnDonacionesRecord,
                                            ),
                                          ),
                                        );
                                      },
